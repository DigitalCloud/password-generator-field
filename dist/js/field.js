...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-password-generation-field', __webpack_require__(3));
    Vue.component('detail-nova-password-generation-field', __webpack_require__(6));
    Vue.component('form-nova-password-generation-field', __webpack_require__(9));
});
    ...
    methods: {
        generate: function generate() {
            ...
            if (this.field.exclude_rules && this.field.exclude_rules.length > 0) {
                ...
                if (this.field.exclude_rules.includes('symbols') && this.field.exclude_rules.includes('numbers') && this.field.exclude_rules.includes('uppercase') && this.field.exclude_rules.includes('lowercase')) {
            ...
            _c("div", { staticClass: "tooltip" }, [
              _c(
                ...
                [
                  _c(
                    "span",
                    { staticClass: "tooltiptext", attrs: { id: "myTooltip" } },
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "icon text-80 svg-inline--fa fa-clone fa-w-16 fa-9x",
                      attrs: {
                        focusable: "false",
                        "data-icon": "clone",
                        role: "img",
